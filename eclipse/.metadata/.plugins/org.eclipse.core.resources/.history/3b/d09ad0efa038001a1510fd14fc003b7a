...
public class Chunk
{
    ...
    public Chunk(World par1World, byte[] par2ArrayOfByte, int par3, int par4)
    {
        ...
        for (int x = 0; x < 16; ++x)
        {
            for (int z = 0; z < 16; ++z)
            {
                ...
                {
                    int var9 = par2ArrayOfByte[x << 11 | z << 7 | y] & 255;
                    ...
                    if (var9 != 0)
                    {
                        ...
                        this.storageArrays[var10].setExtBlockID(x, y & 15, z, var9);
                    }
                }
            }
        }
    ...
    public void generateHeightMap()
    {
        ...
        for (int xitterator = 0; xitterator < 16; ++xitterator)
        {
            int zItterator = 0;

            while (zItterator < 16)
            {
                this.precipitationHeightMap[xitterator + (zItterator << 4)] = -999;
                int y = var1 + 16 - 1;
                ...
                while (true)
                {
                    if (y > 0)
                    {
                        int var5 = this.getBlockID(xitterator, y - 1, zItterator);
                        ...
                        this.heightMap[zItterator << 4 | xitterator] = y;
                    }
    ...
    public void enqueueRelightChecks()
    {
        for (int var1 = 0; var1 < 8; ++var1)
        {
            ...
            System.out.println("lightchecking");*/
