...
import net.minecraft.util.VersionWriter;
...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
	...
	public static String fileSrcUrl = "http://dncminecraft.s3-ap-southeast-2.amazonaws.com/";
    /** A 10MiB preallocation to ensure the heap is reasonably sized. */
    public static byte[] memoryReserve = new byte[10485760];
    private final ILogAgent logAgent = new LogAgent("Minecraft-Client", " [CLIENT]", (new File(getMinecraftDir(), "output-client.log")).getAbsolutePath());
    ...
    {
    	try {
			VersionWriter.writeGameVersionToFile();
		} catch (IOException e) 
    	{
			System.out.println("Could not write game version to file.");
			e.printStackTrace();
		}
        StatList.nopInit();
    ...
    public void startGame() throws LWJGLException
    {
        ...
        if(gameSettings.alphaFoliage)
        {
        	ColorizerGrass.setGrassBiomeColorizer(this.renderEngine.getTextureContents("/misc/alpha_grasscolor.png"));
        	ColorizerFoliage.setFoliageBiomeColorizer(this.renderEngine.getTextureContents("/misc/alpha_foliagecolor.png"));
        }
        else
        {
    ...
    public static File getMinecraftDir()
    {
        ...
        {
            minecraftDir = getAppDir("DNCminecraft");
        }
    ...
    public void installResource(String par1Str, File par2File)
    {
        ...
        else if (var4.equalsIgnoreCase("records"))
        {
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        boolean var3 = true;
        boolean var4 = false;
        String var5 = "disckord";//"Player" + getSystemTime() % 1000L;
        String var6 = var5;
