...
{
    private StringTranslate translator = new StringTranslate("en_Dck");
    ...
    public EntityPlayerMP(MinecraftServer par1MinecraftServer, World par2World, String par3Str, ItemInWorldManager par4ItemInWorldManager)
    {
        ...
        {
            if (par2World.getWorldInfo().getTerrainType() != WorldType.BWG4INDEV1 && par2World.getWorldInfo().getTerrainType() != WorldType.BWG4INDEV2)
            {
                if (par2World.getWorldInfo().getTerrainType() == WorldType.BWG4SKYBLOCK)
                {
                    var8 = 84;
                    var7 = 0;
                    var6 = 0;
            ...
            {
                var8 = par2World.getTopSolidOrLiquidBlock(var6, var7) + 1;
            }
        }
