...
public final class ItemStack
{
    ...
    public ItemStack(int par1, int par2, int par3)
    {
    	...
    	if(par1 == Item.pickaxeHARDGOLD.itemID || par1 == Item.pickaxeQEHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.silkTouch, 1);
    	}

    	if(par1 == Item.axeHARDGOLD.itemID || par1 == Item.axeQEHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.efficiency, 5);
    	}
    	if(par1 == Item.shovelHARDGOLD.itemID || par1 == Item.shovelQEHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.silkTouch, 1);
    	}
    	if(par1 == Item.swordHARDGOLD.itemID || par1 == Item.swordQEHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.looting, 3);
    	}
    	if(par1 == Item.helmetHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.aquaAffinity, 5);
    	}
    	if(par1 == Item.plateHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.projectileProtection, 5);
    	}
    	if(par1 == Item.legsHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.fireProtection, 5);
    	}
    	if(par1== Item.bootsHARDGOLD.itemID)
    	{
    		this.addEnchantment(Enchantment.featherFalling, 5);
    	}
        this.stackSize = 0;
        this.itemFrame = null;
        this.itemID = par1;
