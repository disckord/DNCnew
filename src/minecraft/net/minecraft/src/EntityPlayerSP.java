...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    public void onLivingUpdate()
    {
    	...
    	//#########################################################
    	//PERKS
		if(currentPerk != null && currentPerk != Perk.none && (Minecraft.getMinecraft().gameSettings.thirdPersonView > 0 || Minecraft.getMinecraft().gameSettings.fpperks))
    	{
    		...
    		if (Minecraft.getMinecraft().gameSettings.perkSound && currentPerk.hasSound && currentPerk.getSoundChance(rand))
            {
