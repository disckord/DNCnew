...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static final List villageSpawnBiomes = Arrays.asList(new BiomeGenBase[]
    		{
    				BiomeGenBase.INDEVhell,
    				BiomeGenBase.INDEVnormal,
    				BiomeGenBase.INDEVparadise,
    				BiomeGenBase.INDEVsnow,
    				BiomeGenBase.INDEVwoods,
    				
    				BiomeGenBase.INFDEVdefault,
    				BiomeGenBase.INFDEVsnow,
    				...
    				BiomeGenBase.BETAdesert,
    				BiomeGenBase.BETAforest,
    				BiomeGenBase.BETAplains,
    				BiomeGenBase.BETArainforest,
    				BiomeGenBase.BETAsavanna,
    				BiomeGenBase.BETAseasonalForest,
    				BiomeGenBase.BETAshrubland,
    				BiomeGenBase.BETAswampland,
    				BiomeGenBase.BETAtaiga,
    				BiomeGenBase.BETAtundra
    				});
