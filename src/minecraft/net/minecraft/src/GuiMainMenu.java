...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu()
    {
        ...
        try
        {
            ...
            do
            {
                this.splashText = (String)var3.get(rand.nextInt(var3.size()));
            }
        ...
        var2 = System.getProperty("java_version");
        ...
        else if (var2 != null && var2.startsWith("1.5"))
        {
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Disckords Nostalgia client v " + a1Version.gameVersion;
