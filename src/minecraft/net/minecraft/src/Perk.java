...
public class Perk {
	...
	public static Perk flame = new Perk(1, "flames", "flame", "fire.fire").setParticleFrequency(100, 75).setSoundFrequency(200, 0).setSoundVolume(0.05F).setVertVelocity(0.005f).setSoundSpeed(1.2f).setHasSound(true).setHeightVarMult(1.0D);
	public static Perk bubbles = new Perk(2, "bubbles", "bubble", "liquid.bubble").setParticleFrequency(100, 75).setSoundFrequency(200, 0).setSoundVolume(0.05F).setSoundSpeed(1.5f).setHasSound(true).setHeightVarMult(1.5D);
