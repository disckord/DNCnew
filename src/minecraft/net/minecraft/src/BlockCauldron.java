...
public class BlockCauldron extends Block
{
     ...
     */
    //TODO make 1 after implimenting new transparency
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
    	if(par1World.getBlockMetadata(par2, par3, par4) > 0)
    	{
        	...
        	{
        		if(
        				par1World.getBlockMaterial(par2, par3 - 1, par4) == Material.lava ||
        				par1World.getBlockMaterial(par2, par3 - 1, par4) == Material.fire ||
        				par1World.getBlockMaterial(par2 + 1, par3, par4) == Material.lava ||
        				par1World.getBlockMaterial(par2 - 1, par3, par4) == Material.lava ||
        				par1World.getBlockMaterial(par2, par3, par4 + 1) == Material.lava ||
        				par1World.getBlockMaterial(par2, par3, par4 - 1) == Material.lava 
        				)
        		{
