...
public class RenderLiving extends Render
{
    ...
    public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        try
        {
            ...
            float var17 = par1EntityLiving.getBrightness(par9);
            int var18 = this.getColorMultiplier(par1EntityLiving, var17, par9);

            if (Shaders.useEntityHurtFlash)
            {
                int var19 = par1EntityLiving.hurtTime <= 0 && par1EntityLiving.deathTime <= 0 ? 0 : 102;
                Shaders.setEntityHurtFlash(var19, var18);
            }
            ...
            {
                int var20 = this.shouldRenderPass(par1EntityLiving, var23, par9);
                ...
                if (var20 > 0)
                {
                    ...
                    if ((var20 & 240) == 16)
                    {
                        this.func_82408_c(par1EntityLiving, var23, par9);
                        this.renderPassModel.render(par1EntityLiving, var16, var15, var13, var11 - var10, var12, var14);
                    }

                    if ((var20 & 15) == 15)
                    {
                        var28 = (float)par1EntityLiving.ticksExisted + par9;
            ...
            if (!Shaders.useEntityHurtFlash)
            {
                ...
                if ((var18 >> 24 & 255) > 0 || par1EntityLiving.hurtTime > 0 || par1EntityLiving.deathTime > 0)
                {
                    ...
                    if (par1EntityLiving.hurtTime > 0 || par1EntityLiving.deathTime > 0)
                    {
                        ...
                        {
                            if (this.inheritRenderPass(par1EntityLiving, var24, par9) >= 0)
                            {
                    ...
                    if ((var18 >> 24 & 255) > 0)
                    {
                        ...
                        {
                            if (this.inheritRenderPass(par1EntityLiving, var31, par9) >= 0)
                            {
                                GL11.glColor4f(var28, var21, var30, var22);
                                this.renderPassModel.render(par1EntityLiving, var16, var15, var13, var11 - var10, var12, var14);
                            }
    ...
    protected void passSpecialRender(EntityLiving par1EntityLiving, double par2, double par4, double par6)
    {
        if (Minecraft.isGuiEnabled() && par1EntityLiving != this.renderManager.livingPlayer && !par1EntityLiving.func_98034_c(Minecraft.getMinecraft().thePlayer) && (par1EntityLiving.func_94059_bO() || par1EntityLiving.func_94056_bM() && par1EntityLiving == this.renderManager.field_96451_i))
        {
            ...
            if (var10 < (double)(var12 * var12))
            {
                ...
                {OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit,192.0f,240.0f);
