...
public class Item
{
    ...
    public static Item bread = (new ItemFood(41, 6, 0.6F, false)).setUnlocalizedName("bread");
    ...
    //added items
    public static Item pickaxeHARDWOOD = (new ItemPickaxe(153,EnumToolMaterial.HARDWOOD).setUnlocalizedName("pickaxeHARDWOOD"));
    public static Item pickaxeHARDSTONE = (new ItemPickaxe(154,EnumToolMaterial.HARDSTONE).setUnlocalizedName("pickaxeHARDSTONE"));
    public static Item pickaxeHARDIRON = (new ItemPickaxe(155,EnumToolMaterial.HARDIRON).setUnlocalizedName("pickaxeHARDIRON"));
    public static Item pickaxeHARDDIAMOND = (new ItemPickaxe(156,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("pickaxeHARDDIAMOND"));
    public static Item pickaxeHARDGOLD = (new ItemPickaxe(157,EnumToolMaterial.HARDGOLD).setUnlocalizedName("pickaxeHARDGOLD"));
    
    public static Item shovelHARDWOOD = (new ItemSpade(180,EnumToolMaterial.HARDWOOD).setUnlocalizedName("shovelHARDWOOD"));
    public static Item shovelHARDSTONE = (new ItemSpade(181,EnumToolMaterial.HARDSTONE).setUnlocalizedName("shovelHARDSTONE"));
    public static Item shovelHARDIRON = (new ItemSpade(182,EnumToolMaterial.HARDIRON).setUnlocalizedName("shovelHARDIRON"));
    public static Item shovelHARDDIAMOND = (new ItemSpade(183,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("shovelHARDDIAMOND"));
    public static Item shovelHARDGOLD = (new ItemSpade(184,EnumToolMaterial.HARDGOLD).setUnlocalizedName("shovelHARDGOLD"));
    
    public static Item axeHARDWOOD = (new ItemAxe(185,EnumToolMaterial.HARDWOOD).setUnlocalizedName("hatchetHARDWOOD"));
    public static Item axeHARDSTONE = (new ItemAxe(186,EnumToolMaterial.HARDSTONE).setUnlocalizedName("hatchetHARDSTONE"));
    public static Item axeHARDIRON = (new ItemAxe(187,EnumToolMaterial.HARDIRON).setUnlocalizedName("hatchetHARDIRON"));
    public static Item axeHARDDIAMOND = (new ItemAxe(188,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("hatchetHARDDIAMOND"));
    public static Item axeHARDGOLD = (new ItemAxe(189,EnumToolMaterial.HARDGOLD).setUnlocalizedName("hatchetHARDGOLD"));
    
    public static Item hoeHARDWOOD = (new ItemHoe(190,EnumToolMaterial.HARDWOOD).setUnlocalizedName("hoeHARDWOOD"));
    public static Item hoeHARDSTONE = (new ItemHoe(191,EnumToolMaterial.HARDSTONE).setUnlocalizedName("hoeHARDSTONE"));
    public static Item hoeHARDIRON = (new ItemHoe(192,EnumToolMaterial.HARDIRON).setUnlocalizedName("hoeHARDIRON"));
    public static Item hoeHARDDIAMOND = (new ItemHoe(193,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("hoeHARDDIAMOND"));
    public static Item hoeHARDGOLD = (new ItemHoe(194,EnumToolMaterial.HARDGOLD).setUnlocalizedName("hoeHARDGOLD"));
    
    public static Item swordHARDWOOD = (new ItemSword(195,EnumToolMaterial.HARDWOOD).setUnlocalizedName("swordHARDWOOD"));
    public static Item swordHARDSTONE = (new ItemSword(196,EnumToolMaterial.HARDSTONE).setUnlocalizedName("swordHARDSTONE"));
    public static Item swordHARDIRON = (new ItemSword(197,EnumToolMaterial.HARDIRON).setUnlocalizedName("swordHARDIRON"));
    public static Item swordHARDDIAMOND = (new ItemSword(198,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("swordHARDDIAMOND"));
    public static Item swordHARDGOLD = (new ItemSword(199,EnumToolMaterial.HARDGOLD).setUnlocalizedName("swordHARDGOLD"));
    
    public static ItemArmor helmetHARDIRON = (ItemArmor)(new ItemArmor(200,EnumArmorMaterial.HARDIRON,5,0).setUnlocalizedName("helmetHARDIRON"));
    public static ItemArmor plateHARDIRON =(ItemArmor) (new ItemArmor(201,EnumArmorMaterial.HARDIRON,5,1).setUnlocalizedName("chestplateHARDIRON"));
    public static ItemArmor legsHARDIRON = (ItemArmor)(new ItemArmor(202,EnumArmorMaterial.HARDIRON,5,2).setUnlocalizedName("leggingsHARDIRON"));
    public static ItemArmor bootsHARDIRON = (ItemArmor)(new ItemArmor(203,EnumArmorMaterial.HARDIRON,5,3).setUnlocalizedName("bootsHARDIRON"));
    
    public static ItemArmor helmetHARDDIAMOND = (ItemArmor)(new ItemArmor(204,EnumArmorMaterial.HARDDIAMOND,6,0).setUnlocalizedName("helmetHARDDIAMOND"));
    public static ItemArmor plateHARDDIAMOND = (ItemArmor)(new ItemArmor(205,EnumArmorMaterial.HARDDIAMOND,6,1).setUnlocalizedName("chestplateHARDDIAMOND"));
    public static ItemArmor legsHARDDIAMOND = (ItemArmor)(new ItemArmor(206,EnumArmorMaterial.HARDDIAMOND,6,2).setUnlocalizedName("leggingsHARDDIAMOND"));
    public static ItemArmor bootsHARDDIAMOND = (ItemArmor)(new ItemArmor(207,EnumArmorMaterial.HARDDIAMOND,6,3).setUnlocalizedName("bootsHARDDIAMOND"));
    
    public static ItemArmor helmetHARDGOLD = (ItemArmor)(new ItemArmor(208,EnumArmorMaterial.HARDGOLD,7,0).setUnlocalizedName("helmetHARDGOLD"));
    public static ItemArmor plateHARDGOLD = (ItemArmor)(new ItemArmor(209,EnumArmorMaterial.HARDGOLD,7,1).setUnlocalizedName("chestplateHARDGOLD"));
    public static ItemArmor legsHARDGOLD = (ItemArmor)(new ItemArmor(210,EnumArmorMaterial.HARDGOLD,7,2).setUnlocalizedName("leggingsHARDGOLD"));
    public static ItemArmor bootsHARDGOLD = (ItemArmor)(new ItemArmor(211,EnumArmorMaterial.HARDGOLD,7,3).setUnlocalizedName("bootsHARDGOLD"));
    
    public static Item pickaxeQEIRON = (new ItemPickaxe(212,EnumToolMaterial.QEIRON).setUnlocalizedName("pickaxeQEIRON"));
    public static Item pickaxeQEDIAMOND = (new ItemPickaxe(213,EnumToolMaterial.QEDIAMOND).setUnlocalizedName("pickaxeQEDIAMOND"));
    public static Item pickaxeQEGOLD = (new ItemPickaxe(214,EnumToolMaterial.QEGOLD).setUnlocalizedName("pickaxeQEGOLD"));
    public static Item pickaxeQEHARDIRON = (new ItemPickaxe(215,EnumToolMaterial.QEHARDIRON).setUnlocalizedName("pickaxeQEHARDIRON"));
    public static Item pickaxeQEHARDDIAMOND = (new ItemPickaxe(216,EnumToolMaterial.QEHARDDIAMOND).setUnlocalizedName("pickaxeQEHARDDIAMOND"));
    public static Item pickaxeQEHARDGOLD = (new ItemPickaxe(217,EnumToolMaterial.QEHARDGOLD).setUnlocalizedName("pickaxeQEHARDGOLD"));
    
    public static Item shovelQEIRON = (new ItemSpade(218,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("shovelQEIRON"));
    public static Item shovelQEDIAMOND = (new ItemSpade(219,EnumToolMaterial.QEDIAMOND).setUnlocalizedName("shovelQEDIAMOND"));
    public static Item shovelQEGOLD = (new ItemSpade(220,EnumToolMaterial.HARDGOLD).setUnlocalizedName("shovelQEGOLD"));
    public static Item shovelQEHARDIRON = (new ItemSpade(221,EnumToolMaterial.HARDIRON).setUnlocalizedName("shovelQEHARDIRON"));
    public static Item shovelQEHARDDIAMOND = (new ItemSpade(222,EnumToolMaterial.HARDDIAMOND).setUnlocalizedName("shovelQEHARDDIAMOND"));
    public static Item shovelQEHARDGOLD = (new ItemSpade(223,EnumToolMaterial.HARDGOLD).setUnlocalizedName("shovelQEHARDGOLD"));
    
    public static Item axeQEIRON = (new ItemAxe(224, EnumToolMaterial.QEIRON).setUnlocalizedName("hatchetQEIRON")); 
    public static Item axeQEDIAMOND = (new ItemAxe(225, EnumToolMaterial.QEDIAMOND).setUnlocalizedName("hatchetQEDIAMOND")); 
    public static Item axeQEGOLD = (new ItemAxe(226, EnumToolMaterial.QEGOLD).setUnlocalizedName("hatchetQEGOLD")); 
    public static Item axeQEHARDIRON = (new ItemAxe(227, EnumToolMaterial.QEHARDIRON).setUnlocalizedName("hatchetQEHARDIRON")); 
    public static Item axeQEHARDDIAMOND = (new ItemAxe(228, EnumToolMaterial.QEHARDDIAMOND).setUnlocalizedName("hatchetQEHARDDIAMOND")); 
    public static Item axeQEHARDGOLD = (new ItemAxe(229, EnumToolMaterial.QEHARDGOLD).setUnlocalizedName("hatchetQEHARDGOLD")); 
    
    public static Item swordQEIRON = (new ItemSword(230,EnumToolMaterial.QEIRON).setUnlocalizedName("swordQEIRON"));
    public static Item swordQEDIAMOND = (new ItemSword(231,EnumToolMaterial.QEDIAMOND).setUnlocalizedName("swordQEDIAMOND"));
    public static Item swordQEGOLD = (new ItemSword(232,EnumToolMaterial.QEGOLD).setUnlocalizedName("swordQEGOLD"));
    ...
    public static Item bundledBeefRaw = (new ItemFood(232, 3, 0.3F, true)).setUnlocalizedName("bundledBeefRaw").setMaxStackSize(4);
    public static Item bundledBeefCooked = (new ItemFood(233, 8, 0.8F, true)).setUnlocalizedName("bundledBeefCooked").setMaxStackSize(4);
    
    public static Item bundledBread = (new ItemFood(234, 6, 0.6F, false)).setUnlocalizedName("bundledBread").setMaxStackSize(4);
    
    public static Item bundledFishRaw = (new ItemFood(235, 3, 0.3F, false)).setUnlocalizedName("bundledFishRaw").setMaxStackSize(4);
    public static Item bundledFishCooked = (new ItemFood(236, 8, 0.6F, false)).setUnlocalizedName("bundledFishCooked").setMaxStackSize(4);*/
