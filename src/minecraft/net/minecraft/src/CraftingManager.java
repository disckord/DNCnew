...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
     ...
     //   this.addRecipe(new ItemStack(Item.coal, 9), new Object[] {"#", '#', Block.coalBlock});

        //this.addRecipe(new ItemStack(Item.pickaxeHARDWOOD, 1) new Object[] {"###", " X ", " X ", '#', Block.wood, 'X', Item.stick});
        //this.addRecipe(new ItemStack(Item.pickaxeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Block.blockNetherQuartz, 'X', Item.pickaxeIron});
        this.addRecipe(new ItemStack(Item.shovelQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelIron});
        this.addRecipe(new ItemStack(Item.shovelQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelDiamond});
        this.addRecipe(new ItemStack(Item.shovelQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelGold});
        this.addRecipe(new ItemStack(Item.shovelQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelHARDIRON});
        this.addRecipe(new ItemStack(Item.shovelQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelHARDDIAMOND});
        this.addRecipe(new ItemStack(Item.shovelQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.shovelHARDGOLD});
        
        this.addRecipe(new ItemStack(Item.pickaxeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeIron});
        this.addRecipe(new ItemStack(Item.pickaxeQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeDiamond});
        this.addRecipe(new ItemStack(Item.pickaxeQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeGold});
        this.addRecipe(new ItemStack(Item.pickaxeQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeHARDIRON});
        this.addRecipe(new ItemStack(Item.pickaxeQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeHARDDIAMOND});
        this.addRecipe(new ItemStack(Item.pickaxeQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.pickaxeHARDGOLD});
        
        this.addRecipe(new ItemStack(Item.axeQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeIron});
        this.addRecipe(new ItemStack(Item.axeQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeDiamond});
        this.addRecipe(new ItemStack(Item.axeQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeGold});
        this.addRecipe(new ItemStack(Item.axeQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeHARDIRON});
        this.addRecipe(new ItemStack(Item.axeQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeHARDDIAMOND});
        this.addRecipe(new ItemStack(Item.axeQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.axeHARDGOLD});
        
        this.addRecipe(new ItemStack(Item.swordQEIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordIron});
        this.addRecipe(new ItemStack(Item.swordQEDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordDiamond});
        this.addRecipe(new ItemStack(Item.swordQEGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordGold});
        this.addRecipe(new ItemStack(Item.swordQEHARDIRON, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordHARDIRON});
        this.addRecipe(new ItemStack(Item.swordQEHARDDIAMOND, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordHARDDIAMOND});
        this.addRecipe(new ItemStack(Item.swordQEHARDGOLD, 1), new Object[] {"###", "#X#", "###", '#', Item.netherQuartz, 'X', Item.swordHARDGOLD});
        
        /*this.addRecipe(new ItemStack(Item.bundledPorkRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.porkRaw, '#', Item.silk});
        this.addRecipe(new ItemStack(Item.bundledPorkCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.porkCooked, '#', Item.silk});
        
        this.addRecipe(new ItemStack(Item.bundledBeefRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.beefRaw, '#', Item.silk}); 
        this.addRecipe(new ItemStack(Item.bundledBeefCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.beefCooked, '#', Item.silk});
        
        this.addRecipe(new ItemStack(Item.bundledBread,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.bread, '#', Item.silk});
        
        this.addRecipe(new ItemStack(Item.bundledFishRaw,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.fishRaw, '#', Item.silk});
        this.addRecipe(new ItemStack(Item.bundledFishCooked,4), new Object[] {"#X#", "X#X", "#X#", 'X', Item.fishCooked, '#', Item.silk});*/
        ...
        this.addRecipe(new ItemStack(Block.planks, 4, 0), new Object[] {"#", '#', new ItemStack(Block.wood, 1, 3)});
