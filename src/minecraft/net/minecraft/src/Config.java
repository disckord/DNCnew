...
public class Config
{
    ...
    public static Icon getSideGrassTexture(IBlockAccess var0, int var1, int var2, int var3, int var4, Icon var5)
    {
        ...
        {
            Icon var6 = TextureUtils.getGrassTopIcon();
            byte var7 = 2;
    ...
    public static boolean isAlphaCobbleEnabled()
    {
    	return false;
    }
    public static boolean isAlphaBricksEnabled()
    {
    	return false;
    }
    public static boolean isAlphaFoliageEnabled()
    {
    	return false;
    }
    public static boolean isClearGlassEnabled()
    {
    	return false;
    }
    public static boolean isOldChestsEnabled()
    {
    	return false;
    }
