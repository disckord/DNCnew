...
class EnumOptionsHelper
{
    ...
    static
    {
        ...
        try
        {
            enumOptionsMappingHelperArray[EnumOptions.ALPHATEXTURES.ordinal()] = 15;
        }
        catch (NoSuchFieldError var1)
        {
            ;
        ...
        try
        {
            enumOptionsMappingHelperArray[EnumOptions.ALPHAFOLIAGE.ordinal()] = 17;
        }
        catch (NoSuchFieldError var1)
        {
            ;
        ...
        try
        {
            enumOptionsMappingHelperArray[EnumOptions.OLDCHESTS.ordinal()] = 18;
        }
        catch (NoSuchFieldError var1)
        {
            ;
        ...
        try
        {
            enumOptionsMappingHelperArray[EnumOptions.CLEARGLASS.ordinal()] = 19;
        }
        catch (NoSuchFieldError var1)
        {
            ;
