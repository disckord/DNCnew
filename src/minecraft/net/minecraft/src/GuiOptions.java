...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(102, this.width / 2 - 152, this.height / 6 + 120 - 6, 73, 20, var1.translateKey("options.language")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            if (par1GuiButton.id == 190)
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiShaders(this, this.options));
            }
