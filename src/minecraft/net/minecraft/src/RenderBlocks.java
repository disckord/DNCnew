...
public class RenderBlocks
{
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            switch (renderType)
            {
                ...
                case 22:
                	return renderBlockChest(par1Block, par2, par3, par4);
                	
                default:
                    if (Reflector.ModLoader.exists())
                    {
                        return Reflector.callBoolean(Reflector.ModLoader_renderWorldBlock, new Object[] {this, this.blockAccess, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4), par1Block, Integer.valueOf(renderType)});
                    }
                    else
                    {
                        if (Reflector.FMLRenderAccessLibrary.exists())
                        {
                            return Reflector.callBoolean(Reflector.FMLRenderAccessLibrary_renderWorldBlock, new Object[] {this, this.blockAccess, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4), par1Block, Integer.valueOf(renderType)});
                        }
    ...
    public boolean renderBlockFlowerpot(BlockFlowerPot par1BlockFlowerPot, int par2, int par3, int par4)
    {
        ...
        if (var19 != 0)
        {
            ...
            if (var17 != null)
            {
                Tessellator.instance.setEntity(var17.blockID, 0);
                this.renderBlockByRenderType(var17, par2, par3, par4);
                Tessellator.instance.setEntity(par1BlockFlowerPot.blockID, 0);
            }
            else if (var19 == 9)
            {
                this.renderAllFaces = true;
     ...
     */
    public boolean renderBlockRedstoneWire(Block par1Block, int x, int y, int z)
    {
        Tessellator var5 = Tessellator.instance;
        ...
        boolean isConnectedXNeg = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x - 1, y, z, 1) || !this.blockAccess.isBlockNormalCube(x - 1, y, z) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x - 1, y - 1, z, -1);
        boolean isConnectedXPos = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x + 1, y, z, 3) || !this.blockAccess.isBlockNormalCube(x + 1, y, z) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x + 1, y - 1, z, -1);
        boolean isConnectedZNeg = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y, z - 1, 2) || !this.blockAccess.isBlockNormalCube(x, y, z - 1) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y - 1, z - 1, -1);
        boolean isConnectedZPos = BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y, z + 1, 0) || !this.blockAccess.isBlockNormalCube(x, y, z + 1) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y - 1, z + 1, -1);
        ...
        if (!this.blockAccess.isBlockNormalCube(x, y + 1, z))
        {
            ...
            {
                isConnectedXNeg = true;
            }

            if (this.blockAccess.isBlockNormalCube(x + 1, y, z) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x + 1, y + 1, z, -1))
            {
                isConnectedXPos = true;
            }

            if (this.blockAccess.isBlockNormalCube(x, y, z - 1) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y + 1, z - 1, -1))
            {
                isConnectedZNeg = true;
            }

            if (this.blockAccess.isBlockNormalCube(x, y, z + 1) && BlockRedstoneWire.isPowerProviderOrWire(this.blockAccess, x, y + 1, z + 1, -1))
            {
                isConnectedZPos = true;
            }
        }

        float var21 = (float)(x + 0);
        float var22 = (float)(x + 1);
        float var23 = (float)(z + 0);
        float var24 = (float)(z + 1);
        boolean var25 = false;
       boolean addedToFixRedstone = false;
        
        if ((isConnectedXNeg || isConnectedXPos) && !isConnectedZNeg && !isConnectedZPos)
        {
           var25 = true;
        }

        if ((isConnectedZNeg || isConnectedZPos) && !isConnectedXPos && !isConnectedXNeg)
        {
        	addedToFixRedstone = true;//removed
            var25 = false;//true
        }

        if(addedToFixRedstone)
        {
        	   var22 += 0.13F;
        }
        if (!var25 && !addedToFixRedstone)
        {
            int var26 = 0;
            int var27 = 0;
            int var28 = 16;
            ...
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)var7.getInterpolatedU((double)var28), (double)var7.getInterpolatedV((double)var29));
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)var7.getInterpolatedU((double)var28), (double)var7.getInterpolatedV((double)var27));
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)var7.getInterpolatedU((double)var26), (double)var7.getInterpolatedV((double)var27));
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)var7.getInterpolatedU((double)var26), (double)var7.getInterpolatedV((double)var29));
            var5.setColorOpaque_F(var11, var11, var11);
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)var9.getInterpolatedU((double)var28), (double)var9.getInterpolatedV((double)var29));
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)var9.getInterpolatedU((double)var28), (double)var9.getInterpolatedV((double)var27));
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)var9.getInterpolatedU((double)var26), (double)var9.getInterpolatedV((double)var27));
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)var9.getInterpolatedU((double)var26), (double)var9.getInterpolatedV((double)var29));
        }
        else if (var25)
        {
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
            var5.setColorOpaque_F(var11, var11, var11);
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)var10.getMaxU(), (double)var10.getMaxV());
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)var10.getMaxU(), (double)var10.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)var10.getMinU(), (double)var10.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)var10.getMinU(), (double)var10.getMaxV());
        }
        else
        {
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
            var5.setColorOpaque_F(var11, var11, var11);
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var24, (double)var10.getMaxU(), (double)var10.getMaxV());
            var5.addVertexWithUV((double)var22, (double)y + 0.015625D, (double)var23, (double)var10.getMinU(), (double)var10.getMaxV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var23, (double)var10.getMinU(), (double)var10.getMinV());
            var5.addVertexWithUV((double)var21, (double)y + 0.015625D, (double)var24, (double)var10.getMaxU(), (double)var10.getMinV());
        }
        ...
        if (!this.blockAccess.isBlockNormalCube(x, y + 1, z))
        {
            if (this.blockAccess.isBlockNormalCube(x - 1, y, z) && this.blockAccess.getBlockId(x - 1, y + 1, z) == Block.redstoneWire.blockID)
            {
                ...
                var5.addVertexWithUV((double)x + 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 1), (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)(y + 0), (double)(z + 1), (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)(y + 0), (double)(z + 0), (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 0), (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
                var5.setColorOpaque_F(var11, var11, var11);
                var5.addVertexWithUV((double)x + 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 1), (double)var10.getMaxU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)(y + 0), (double)(z + 1), (double)var10.getMinU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)(y + 0), (double)(z + 0), (double)var10.getMinU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)x + 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 0), (double)var10.getMaxU(), (double)var10.getMaxV());
            }

            if (this.blockAccess.isBlockNormalCube(x + 1, y, z) && this.blockAccess.getBlockId(x + 1, y + 1, z) == Block.redstoneWire.blockID)
            {
                var5.setColorOpaque_F(var11 * var13, var11 * var14, var11 * var15);
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)(y + 0), (double)(z + 1), (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 1), (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 0), (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)(y + 0), (double)(z + 0), (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
                var5.setColorOpaque_F(var11, var11, var11);
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)(y + 0), (double)(z + 1), (double)var10.getMinU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 1), (double)var10.getMaxU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)((float)(y + 1) + 0.021875F), (double)(z + 0), (double)var10.getMaxU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)(x + 1) - 0.015625D, (double)(y + 0), (double)(z + 0), (double)var10.getMinU(), (double)var10.getMinV());
            }

            if (this.blockAccess.isBlockNormalCube(x, y, z - 1) && this.blockAccess.getBlockId(x, y + 1, z - 1) == Block.redstoneWire.blockID)
            {
                var5.setColorOpaque_F(var11 * var13, var11 * var14, var11 * var15);
                var5.addVertexWithUV((double)(x + 1), (double)(y + 0), (double)z + 0.015625D, (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)(x + 1), (double)((float)(y + 1) + 0.021875F), (double)z + 0.015625D, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)(x + 0), (double)((float)(y + 1) + 0.021875F), (double)z + 0.015625D, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)z + 0.015625D, (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
                var5.setColorOpaque_F(var11, var11, var11);
                var5.addVertexWithUV((double)(x + 1), (double)(y + 0), (double)z + 0.015625D, (double)var10.getMinU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)(x + 1), (double)((float)(y + 1) + 0.021875F), (double)z + 0.015625D, (double)var10.getMaxU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)(x + 0), (double)((float)(y + 1) + 0.021875F), (double)z + 0.015625D, (double)var10.getMaxU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)z + 0.015625D, (double)var10.getMinU(), (double)var10.getMinV());
            }

            if (this.blockAccess.isBlockNormalCube(x, y, z + 1) && this.blockAccess.getBlockId(x, y + 1, z + 1) == Block.redstoneWire.blockID)
            {
                var5.setColorOpaque_F(var11 * var13, var11 * var14, var11 * var15);
                var5.addVertexWithUV((double)(x + 1), (double)((float)(y + 1) + 0.021875F), (double)(z + 1) - 0.015625D, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)(x + 1), (double)(y + 0), (double)(z + 1) - 0.015625D, (double)redstoneLine.getMinU(), (double)redstoneLine.getMinV());
                var5.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)(z + 1) - 0.015625D, (double)redstoneLine.getMinU(), (double)redstoneLine.getMaxV());
                var5.addVertexWithUV((double)(x + 0), (double)((float)(y + 1) + 0.021875F), (double)(z + 1) - 0.015625D, (double)redstoneLine.getMaxU(), (double)redstoneLine.getMaxV());
                var5.setColorOpaque_F(var11, var11, var11);
                var5.addVertexWithUV((double)(x + 1), (double)((float)(y + 1) + 0.021875F), (double)(z + 1) - 0.015625D, (double)var10.getMaxU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)(x + 1), (double)(y + 0), (double)(z + 1) - 0.015625D, (double)var10.getMinU(), (double)var10.getMinV());
                var5.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)(z + 1) - 0.015625D, (double)var10.getMinU(), (double)var10.getMaxV());
                var5.addVertexWithUV((double)(x + 0), (double)((float)(y + 1) + 0.021875F), (double)(z + 1) - 0.015625D, (double)var10.getMaxU(), (double)var10.getMaxV());
            }
        }

        if (Config.isBetterSnow() && this.hasSnowNeighbours(x, y, z))
        {
            this.renderSnow(x, y, z, 0.01D);
        }
    ...
    public boolean renderBlockPane(BlockPane par1BlockPane, int par2, int par3, int par4)
    {
        ...
        var6.setColorOpaque_F(var7 * var9, var7 * var10, var7 * var11);
        ConnectedProperties var104 = null;
        Icon var15;
        int var105;
        Icon var106;
        ...
        if (this.hasOverrideBlockTexture())
        {
            var106 = this.overrideBlockTexture;
            var15 = this.overrideBlockTexture;
        }
        else
        {
            var105 = this.blockAccess.getBlockMetadata(par2, par3, par4);
            var106 = this.getBlockIconFromSideAndMetadata(par1BlockPane, 0, var105);
            var15 = par1BlockPane.getSideTextureIndex();

            if (Config.isConnectedTextures())
            {
                var104 = ConnectedTextures.getConnectedProperties(this.blockAccess, par1BlockPane, par2, par3, par4, -1, var106);
            }
        }
        ...
        if (var104 != null)
        {
            ...
            var106 = ConnectedTextures.getCtmTexture(var104, var32, var106);
            var16 = ConnectedTextures.getCtmTexture(var104, var33, var16);
            var17 = ConnectedTextures.getCtmTexture(var104, var34, var17);
            var18 = ConnectedTextures.getCtmTexture(var104, var35, var18);
        }

        var105 = var106.getOriginX();
        var19 = var106.getOriginY();
        double var107 = (double)var106.getMinU();
        double var108 = (double)var106.getInterpolatedU(8.0D);
        double var109 = (double)var106.getMaxU();
        double var110 = (double)var106.getMinV();
        double var111 = (double)var106.getMaxV();
        ...
        int var66 = var15.getOriginX();
        int var67 = var15.getOriginY();
        double var68 = (double)var15.getInterpolatedU(7.0D);
        double var70 = (double)var15.getInterpolatedU(9.0D);
        double var72 = (double)var15.getMinV();
        double var74 = (double)var15.getInterpolatedV(8.0D);
        double var76 = (double)var15.getMaxV();
    ...
    public void drawCrossedSquares(Block par1Block, int par2, double par3, double par5, double par7, float par9)
    {
        ...
        float var30 = 0.70710677F;
        var10.setNormal(-0.70710677F, 0.0F, 0.70710677F);
    ...
    public boolean renderBlockFluids(Block par1Block, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            {
                var13 = true;
                Icon var48 = this.getBlockIconFromSideAndMetadata(par1Block, 1, var23);
                float var49 = (float)BlockFluid.getFlowDirection(this.blockAccess, par2, par3, par4, var22);

                if (var49 > -999.0F)
                {
                    var48 = this.getBlockIconFromSideAndMetadata(par1Block, 2, var23);
                }
                ...
                if (var49 < -999.0F)
                {
                    var38 = (double)var48.getInterpolatedU(0.0D);
                    var46 = (double)var48.getInterpolatedV(0.0D);
                    var50 = var38;
                    var40 = (double)var48.getInterpolatedV(16.0D);
                    var42 = (double)var48.getInterpolatedU(16.0D);
                    var52 = var40;
                    var36 = var42;
                    var44 = var46;
                }
                ...
                {
                    var35 = MathHelper.sin(var49) * 0.25F;
                    var34 = MathHelper.cos(var49) * 0.25F;
                    var38 = (double)var48.getInterpolatedU((double)(8.0F + (-var34 - var35) * 16.0F));
                    var46 = (double)var48.getInterpolatedV((double)(8.0F + (-var34 + var35) * 16.0F));
                    var50 = (double)var48.getInterpolatedU((double)(8.0F + (-var34 + var35) * 16.0F));
                    var40 = (double)var48.getInterpolatedV((double)(8.0F + (var34 + var35) * 16.0F));
                    var42 = (double)var48.getInterpolatedU((double)(8.0F + (var34 + var35) * 16.0F));
                    var52 = (double)var48.getInterpolatedV((double)(8.0F + (var34 - var35) * 16.0F));
                    var36 = (double)var48.getInterpolatedU((double)(8.0F + (var34 - var35) * 16.0F));
                    var44 = (double)var48.getInterpolatedV((double)(8.0F + (-var34 - var35) * 16.0F));
                }
                ...
                var5.setNormalCP(1.0F, (float)(var28 - var24), 1.0F, 1.0F, (float)(var30 - var26), -1.0F);
                var5.addVertexWithUV((double)(par2 + 0), (double)par3 + var24, (double)(par4 + 0), var38 + var54, var46 + var54);
                var5.addVertexWithUV((double)(par2 + 0), (double)par3 + var26, (double)(par4 + 1), var50 + var54, var40 - var54);
                var5.addVertexWithUV((double)(par2 + 1), (double)par3 + var28, (double)(par4 + 1), var42 - var54, var52 - var54);
                var5.addVertexWithUV((double)(par2 + 1), (double)par3 + var30, (double)(par4 + 0), var36 - var54, var44 + var54);
            }
            ...
            for (int var58 = 0; var58 < 4; ++var58)
            {
                ...
                Icon var51 = this.getBlockIconFromSideAndMetadata(par1Block, var58 + 2, var23);
                ...
                if (this.renderAllFaces || var12[var58])
                {
                    ...
                    else if (var58 == 2)
                    {
                        ...
                        var38 = var26;
                        var42 = var24;
                        var36 = (double)par2 + var32;
                        var40 = (double)par2 + var32;
                        var46 = (double)(par4 + 1);
                        var44 = (double)par4;
                    }
                    else
                    {
                        ...
                        var38 = var30;
                        var42 = var28;
                        var36 = (double)(par2 + 1) - var32;
                        var40 = (double)(par2 + 1) - var32;
                        var46 = (double)par4;
                        var44 = (double)(par4 + 1);
                    }

                    var13 = true;
                    float var60 = var51.getInterpolatedU(0.0D);
                    var35 = var51.getInterpolatedU(8.0D);
                    var34 = var51.getInterpolatedV((1.0D - var38) * 16.0D * 0.5D);
                    float var53 = var51.getInterpolatedV((1.0D - var42) * 16.0D * 0.5D);
                    float var61 = var51.getInterpolatedV(8.0D);
                    ...
                    var5.addVertexWithUV(var36, (double)par3 + var38, var46, (double)var60, (double)var34);
                    var5.addVertexWithUV(var40, (double)par3 + var42, var44, (double)var35, (double)var53);
                    var5.addVertexWithUV(var40, (double)(par3 + 0), var44, (double)var35, (double)var61);
                    var5.addVertexWithUV(var36, (double)(par3 + 0), var46, (double)var60, (double)var61);
                }
            }
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            var21 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 + 1, par3 - 1, par4)];
            var19 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 - 1, par4)];
            var23 = Block.canBlockGrass[this.blockAccess.getBlockId(par2, par3 - 1, par4 + 1)];
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3 - 1, par4);
            var12 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXYNN + this.aoLightValueScratchYZNP + var22) / 4.0F;
            var15 = (this.aoLightValueScratchYZNP + var22 + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXYPN) / 4.0F;
            var14 = (var22 + this.aoLightValueScratchYZNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNN) / 4.0F;
            var13 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNN + var22 + this.aoLightValueScratchYZNN) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 + 1, par4, 1))
        {
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3 + 1, par4);
            var15 = (this.aoLightValueScratchXYZNPP + this.aoLightValueScratchXYNP + this.aoLightValueScratchYZPP + var22) / 4.0F;
            var12 = (this.aoLightValueScratchYZPP + var22 + this.aoLightValueScratchXYZPPP + this.aoLightValueScratchXYPP) / 4.0F;
            var13 = (var22 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPN) / 4.0F;
            var14 = (this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPN + var22 + this.aoLightValueScratchYZPN) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 - 1);
            var12 = (this.aoLightValueScratchXZNN + this.aoLightValueScratchXYZNPN + var22 + this.aoLightValueScratchYZPN) / 4.0F;
            var13 = (var22 + this.aoLightValueScratchYZPN + this.aoLightValueScratchXZPN + this.aoLightValueScratchXYZPPN) / 4.0F;
            var14 = (this.aoLightValueScratchYZNN + var22 + this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXZPN) / 4.0F;
            var15 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXZNN + this.aoLightValueScratchYZNN + var22) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 + 1);
            var12 = (this.aoLightValueScratchXZNP + this.aoLightValueScratchXYZNPP + var22 + this.aoLightValueScratchYZPP) / 4.0F;
            var15 = (var22 + this.aoLightValueScratchYZPP + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYZPPP) / 4.0F;
            var14 = (this.aoLightValueScratchYZNP + var22 + this.aoLightValueScratchXYZPNP + this.aoLightValueScratchXZPP) / 4.0F;
            var13 = (this.aoLightValueScratchXYZNNP + this.aoLightValueScratchXZNP + this.aoLightValueScratchYZNP + var22) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            var21 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 + 1, par4)];
            var19 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3 - 1, par4)];
            var23 = Block.canBlockGrass[this.blockAccess.getBlockId(par2 - 1, par3, par4 - 1)];
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2 - 1, par3, par4);
            var15 = (this.aoLightValueScratchXYNN + this.aoLightValueScratchXYZNNP + var22 + this.aoLightValueScratchXZNP) / 4.0F;
            var12 = (var22 + this.aoLightValueScratchXZNP + this.aoLightValueScratchXYNP + this.aoLightValueScratchXYZNPP) / 4.0F;
            var13 = (this.aoLightValueScratchXZNN + var22 + this.aoLightValueScratchXYZNPN + this.aoLightValueScratchXYNP) / 4.0F;
            var14 = (this.aoLightValueScratchXYZNNN + this.aoLightValueScratchXYNN + this.aoLightValueScratchXZNN + var22) / 4.0F;
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            var22 = this.getAmbientOcclusionLightValue(this.blockAccess, par2 + 1, par3, par4);
            var12 = (this.aoLightValueScratchXYPN + this.aoLightValueScratchXYZPNP + var22 + this.aoLightValueScratchXZPP) / 4.0F;
            var13 = (this.aoLightValueScratchXYZPNN + this.aoLightValueScratchXYPN + this.aoLightValueScratchXZPN + var22) / 4.0F;
            var14 = (this.aoLightValueScratchXZPN + var22 + this.aoLightValueScratchXYZPPN + this.aoLightValueScratchXYPP) / 4.0F;
            var15 = (var22 + this.aoLightValueScratchXZPP + this.aoLightValueScratchXYPP + this.aoLightValueScratchXYZPPP) / 4.0F;
    ...
    public boolean func_102027_b(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            var21 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3 - 1, par4);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            var21 = this.getAmbientOcclusionLightValue(this.blockAccess, par2, par3, par4 - 1);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            var21 = this.getAmbientOcclusionLightValue(this.blockAccess, par2 - 1, par3, par4);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            if (var9)
            {
                if (var18 == TextureUtils.iconGrassSide || var18 == TextureUtils.iconMycelSide)
                {
                    ...
                    if (var18 == TextureUtils.getGrassTopIcon())
                    {
    ...
    public void renderBlockAsItem(Block par1Block, int par2, float par3)
    {
        ...
        boolean isGrass = par1Block.blockID == Block.grass.blockID;
        ...
        else
        {
            ...
            {
                if (par1Block.blockMaterial == Material.glass)
                {
                    GL11.glDisable(GL11.GL_CULL_FACE);
                }
                else if (par1Block.blockMaterial == Material.ice)
                {
    ...
    private Icon fixAoSideGrassTexture(Icon var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8)
    {
        if (var1 == TextureUtils.iconGrassSide || var1 == TextureUtils.iconMycelSide)
        {
            ...
            if (var1 == TextureUtils.getGrassTopIcon())
            {
