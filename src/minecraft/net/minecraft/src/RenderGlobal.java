...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void loadRenderers()
    {
        if (this.theWorld != null)
        {
            ...
            for (var6 = 0; var6 < this.worldRenderersToUpdate.size(); ++var6)
            {
                WorldRenderer var7 = (WorldRenderer)this.worldRenderersToUpdate.get(var6);
            ...
            for (var6 = 0; var6 < this.renderChunksWide; ++var6)
            {
                for (int var10 = 0; var10 < this.renderChunksTall; ++var10)
                {
                    for (int var8 = 0; var8 < this.renderChunksDeep; ++var8)
                    {
                        int var9 = (var8 * this.renderChunksTall + var10) * this.renderChunksWide + var6;
                        this.worldRenderers[var9] = WrUpdates.makeWorldRenderer(this.theWorld, this.tileEntities, var6 * 16, var10 * 16, var8 * 16, this.glRenderListBase + var4);

                        if (this.occlusionEnabled)
                        {
                            this.worldRenderers[var9].glOcclusionQuery = this.glOcclusionQueryBase.get(var5);
                        }

                        this.worldRenderers[var9].isWaitingOnOcclusionQuery = false;
                        this.worldRenderers[var9].isVisible = true;
                        this.worldRenderers[var9].isInFrustum = false;
                        this.worldRenderers[var9].chunkIndex = var5++;
                        this.sortedWorldRenderers[var9] = this.worldRenderers[var9];

                        if (this.theWorld.chunkExists(var6, var8))
                        {
                            this.worldRenderers[var9].markDirty();
                            this.worldRenderersToUpdate.add(this.worldRenderers[var9]);
                        }
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        double var41 = par1EntityLiving.lastTickPosX + (par1EntityLiving.posX - par1EntityLiving.lastTickPosX) * par3;
        double var42 = par1EntityLiving.lastTickPosY + (par1EntityLiving.posY - par1EntityLiving.lastTickPosY) * par3;
        ...
        if (var18 > 16.0D)
        {
            ...
            var29 = (int)par1EntityLiving.posX;
        ...
        if (this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph && par2 == 0)
        {
            byte var44 = 0;
            byte var24 = 20;
            this.checkOcclusionQueryResult(var44, var24, par1EntityLiving.posX, par1EntityLiving.posY, par1EntityLiving.posZ);
            int var45;

            for (var45 = var44; var45 < var24; ++var45)
            {
                this.sortedWorldRenderers[var45].isVisible = true;
            }

            var5.endStartSection("render");
            var20 = var43 + this.renderSortedRenderers(var44, var24, par2, par3);
            var45 = var24;
            int var26 = 0;
            byte var46 = 40;
            int var28;

            for (var29 = this.renderChunksWide; var45 < this.sortedWorldRenderers.length; var20 += this.renderSortedRenderers(var28, var45, par2, par3))
            {
                ...
                if (var45 > this.sortedWorldRenderers.length)
                {
                    var45 = this.sortedWorldRenderers.length;
                }

                Shaders.sglDisableT2D(3553);
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_ALPHA_TEST);
                Shaders.sglDisableFog(2912);
                GL11.glColorMask(false, false, false, false);
                GL11.glDepthMask(false);
                var5.startSection("check");
                this.checkOcclusionQueryResult(var28, var45, par1EntityLiving.posX, par1EntityLiving.posY, par1EntityLiving.posZ);
                var5.endSection();
                GL11.glPushMatrix();
                float var47 = 0.0F;
                float var48 = 0.0F;
                ...
                {
                    WorldRenderer var34 = this.sortedWorldRenderers[var33];

                    if (var34.skipAllRenderPasses())
                    {
                        var34.isInFrustum = false;
                    }
                    else if (var34.isUpdating)
                    {
                        var34.isVisible = true;
                    }
                    else if (var34.isInFrustum)
                    {
                        if (Config.isOcclusionFancy() && !var34.isInFrustrumFully)
                        {
                            var34.isVisible = true;
                        }
                        else if (var34.isInFrustum && !var34.isWaitingOnOcclusionQuery)
                        {
                            float var35;
                            float var36;
                            float var37;
                            ...
                            if (var34.isVisibleFromPosition)
                            {
                                var35 = Math.abs((float)(var34.visibleFromX - par1EntityLiving.posX));
                                var36 = Math.abs((float)(var34.visibleFromY - par1EntityLiving.posY));
                                var37 = Math.abs((float)(var34.visibleFromZ - par1EntityLiving.posZ));
                                ...
                                var34.isVisibleFromPosition = false;
                            }

                            var35 = (float)((double)var34.posXMinus - var41);
                            var36 = (float)((double)var34.posYMinus - var42);
                            var37 = (float)((double)var34.posZMinus - var10);
                            var38 = var35 - var47;
                            ...
                            ARBOcclusionQuery.glBeginQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB, var34.glOcclusionQuery);
                            var34.callOcclusionQueryList();
                            ARBOcclusionQuery.glEndQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB);
                            var5.endSection();
                            var34.isWaitingOnOcclusionQuery = true;
                            ++var22;
                        }
                    }
                }
                ...
                Shaders.sglEnableT2D(3553);
                GL11.glEnable(GL11.GL_ALPHA_TEST);
                Shaders.sglEnableFog(2912);
                var5.endStartSection("render");
            }
        }
        else
        {
            var5.endStartSection("render");
            var20 = var43 + this.renderSortedRenderers(0, this.sortedWorldRenderers.length, par2, par3);
        }
    ...
    public void renderSky(float par1)
    {
        ...
        else if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            if (var26 != null && Config.isSunMoonEnabled())
            {
                ...
                var25.setColorRGBA_F(var6, var9, var10, var26[3]);
                ...
                {
                    var13 = (float)var14 * (float)Math.PI * 2.0F / (float)var17;
                    var16 = MathHelper.sin(var13);
                    var15 = MathHelper.cos(var13);
                    var25.addVertex((double)(var16 * 120.0F), (double)(var15 * 120.0F), (double)(-var15 * 40.0F * var26[3]));
                }
            ...
            if (Config.isSunMoonEnabled())
            {
                ...
                var25.startDrawingQuads();
                var25.addVertexWithUV((double)(-var12), -100.0D, (double)var12, (double)var19, (double)var20);
                var25.addVertexWithUV((double)var12, -100.0D, (double)var12, (double)var16, (double)var20);
                var25.addVertexWithUV((double)var12, -100.0D, (double)(-var12), (double)var16, (double)var15);
                var25.addVertexWithUV((double)(-var12), -100.0D, (double)(-var12), (double)var19, (double)var15);
                var25.draw();
            }
        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                    	 var21 = new EntitySteamFX(this.theWorld, par2, par4, par6, par8, par10, par12);
                    }
        ...
        switch (par2)
        {
            ...
            case 2000:
                ...
                for (int var43 = 0; var43 < 10; ++var43)
                {
                    ...
                    this.spawnParticle("smoke", var45, var25, var16, var19, var21, var23);
                }
            ...
            case 2001:
                ...
                if (var18 > 0)
                {
                    Block var42 = Block.blocksList[var18];
            ...
            case 2002:
                ...
                for (var18 = 0; var18 < 100; ++var18)
                {
                    ...
                    var16 = var7.nextDouble() * Math.PI * 2.0D;
