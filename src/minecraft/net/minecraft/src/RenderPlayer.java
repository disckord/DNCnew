...
public class RenderPlayer extends RenderLiving
{
    ...
    private static final String[] armorFilenamePrefix = new String[] {"cloth", "chain", "iron", "diamond", "gold", "HARDIRON", "HARDDIAMOND", "HARDGOLD"};
    ...
    protected void func_96450_a(EntityPlayer par1EntityPlayer, double par2, double par4, double par6, String par8Str, float par9, double par10)
    {
        if (par10 < 100.0D)
        {
            ...
            if (var13 != null)
            {
                ...
                {
                    this.renderLivingLabel(par1EntityPlayer, var14.func_96652_c() + " " + var13.getDisplayName(), par2, 255, par6, 64);
                }
