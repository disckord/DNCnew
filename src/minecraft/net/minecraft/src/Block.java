...
public class Block
{
    ...
    public static final Block coalBlock = (new BlockOreStorage(159).setHardness(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("coalBlock"));
    public static final Block rottingWood = (new Block(160, Material.wood).setHardness(2.0F).setStepSound(soundWoodFootstep).setResistance(5.0F).setCreativeTab(CreativeTabs.tabBlock).setUnlocalizedName("rottingwood"));
    public static final Block stairsRottingWood = (new BlockStairs(161, rottingWood, 0)).setUnlocalizedName("stairsRottingWood");
    public static final Block stairsMossyCobble = (new BlockStairs(162, cobblestoneMossy, 0)).setUnlocalizedName("stairsMossyCobble");
    ...
    protected void setIsSteaming(boolean flag)
    {
    ...
    public boolean shouldSideBeRendered(IBlockAccess par1IBlockAccess, int x, int y, int z, int side)
    {
        ...
        : !par1IBlockAccess.isBlockOpaqueCube(x, y, z))))));
    }
    ...
    public Icon getIcon(int par1, int par2)
    {
    	...
    	if(Config.getGameSettings().alphaTextures)
    	{
    		if(this == Block.cobblestone)
    		return this.alphaCobbleIcon;
    ...
    {
    	if(this == Block.cobblestone){
    		this.alphaCobbleIcon = par1IconRegister.registerIcon("alpha_" + this.unlocalizedName);
    	}
    	if(this == Block.brick){
