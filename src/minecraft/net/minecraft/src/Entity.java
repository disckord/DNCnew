...
public abstract class Entity
{
    ...
    public void onEntityUpdate()
    {
        ...
        if (!this.inWater && !this.firstUpdate)
        {
            ...
            float var21 = (float)MathHelper.floor_double(this.boundingBox.minY);
            int var3;
            float var4;
            float var5;
            ...
            for (var3 = 0; (float)var3 < 1.0F + this.width * 20.0F; ++var3)
            {
                ...
                this.worldObj.spawnParticle("bubble", this.posX + (double)var4, (double)(var21 + 1.0F), this.posZ + (double)var5, this.motionX, this.motionY - (double)(this.rand.nextFloat() * 0.2F), this.motionZ);
            }
            ...
            for (var3 = 0; (float)var3 < 1.0F + this.width * 20.0F; ++var3)
            {
                var4 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                var5 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                this.worldObj.spawnParticle("splash", this.posX + (double)var4, (double)(var21 + 1.0F), this.posZ + (double)var5, this.motionX, this.motionY, this.motionZ);
            }
        }
